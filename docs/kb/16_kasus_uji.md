...
| M4 | 3 akh syaqiq (asal 3), 2 di antaranya wafat, masing-masing meninggalkan zawjah + bint | 3 → 384 | Akh (penyintas) 209; zawjah₁ 16; bint₁ 64; zawjah₂ 19; bint₂ 76 | Keadaan 3 bertahap (akh penyintas mewarisi dari kedua saudaranya): 3 → 48 (mayit A: 8 → tashih 16, tabayun; akh B dan C masing-masing 19) → 384 (mayit B: 8, 19 vs 8 tabayun; akh C 152 + 57) |
...
| M8 | Mayit 1: zawjah, 2 bint (bukan dari zawjah), 'amm (asal 24: 3, 8, 8, 5). Keempatnya wafat: bint 1 → umm, zawj, ibn; bint 2 → umm, ibn; 'amm → zawjah, ibn; zawjah → umm, ab | 24 → 576 | Umm zawjah 24; ab zawjah 48; umm bint 1 32; zawj bint 1 48; ibn bint 1 112; umm bint 2 32; ibn bint 2 160; zawjah 'amm 15; ibn 'amm 105 | Keadaan 2 (jami'ah bersama): wafq mas'alah 3 (12, tawafuq), 3 (6, tawafuq), 8 (tabayun), 1 (tamatsul) → 24; jami'ah 24 × 24; pengali 16, 32, 15, 24 |
| M9 | Mayit 1: zawjah, bint (dari zawjah), 'amm (asal 8: 1, 4, 3) → bint wafat (umm, 'amm) → zawjah wafat (zawj = 'amm, ibn darinya) → 'amm wafat (zawjah baru, ibn dari zawjah pertama) | 8 → 24 → 96 → 768 | Zawjah ('amm) 75; ibn 693 | Keadaan 3, 4 mayit berantai, semua tabayun. Tabel kitab mencetak ibn "٦١٣=٥٢٥+١٦٨"; 525 + 168 = 693 dan 75 + 693 = 768, jadi dipakai 693 (perlu dicek ke cetakan) |

> M3–M9 ditranskripsi dari tabel Lahim. Tiap angka diverifikasi ulang: saham akhir = saham mas'alah sebelumnya × pengalinya + saham mas'alah mayit berikutnya × pengalinya, dan jumlahnya sama dengan jami'ah di kitab.
...
| R16-12 | Kasus M8 (Keadaan 2, jami'ah 576) | Lahim | Lahim, contoh «انقسام السهام على بعض المسائل الثانية» | «توفي شخص عن زوجة وبنتين من غيرها وعم، فلم تقسم التركة حتى ماتت إحدى البنتين عن أم وزوج وابن، والثانية عن أم وابن، والعم عن زوجة وابن، والزوجة عن أم وأب» |
| R16-13 | Kasus M9 (4 mayit, jami'ah 768) | Lahim | Lahim, contoh «ما إذا كان في المسألة أربعة أموات» | «توفي رجل عن زوجة وبنت منها وعم، فلم تقسم التركة حتى ماتت البنت عمن في المسألة، ثم الزوجة بعد أن تزوجها العم عنه وعن ابن منه، ثم توفي العم عن زوجة وابنه من الزوجة الأولى» |
