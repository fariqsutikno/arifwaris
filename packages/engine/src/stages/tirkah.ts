import type { Money } from '@waris/math';
import type { TirkahInput, TraceStep } from '../types.js';

const nonNegative = (x: Money): Money => (x < 0n ? 0n : x);
 ...
 */
export function computeTirkah(tirkah: TirkahInput): { bersih: Money; trace: Extract<TraceStep, { kind: 'TIRKAH' }> } {
